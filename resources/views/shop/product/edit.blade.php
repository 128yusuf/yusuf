...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card-body">
                <form method="post" action="{{ route('product.update',['id' => $data->id]) }}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @method('post')
                    ...
                    <div class="pl-lg-4 row">
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('product_name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="product_name" id="input-product_name" class="form-control form-control-alternative{{ $errors->has('product_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Name') }}" value="{{ old('product_name', $data->product_name) }}" autofocus>
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="price" id="input-price" class="form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ old('price', $data->price) }}" autofocus>
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('category') ? ' has-danger' : '' }}">
                            ...
                            <select class="form-control" name="category" id="category">
                                ...
                                @foreach(config('constant.category') as $key => $value )
                                    <option value={{ $key }} {{ $data->category == $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('sub_category') ? ' has-danger' : '' }}">
                            ...
                            <select class="form-control" name="sub_category" id="sub_category">
                                <option value="">Select</option>
                                @foreach(config('constant.sub_category')[$data->category] as $key => $value )
                                    <option value={{ $key }} {{ $data->sub_category == $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                            ...
                            <textarea name="description" id="description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}"  rows="5">{{ old('description', $data->description) }}</textarea>
                        ...
                        <div class="col-md-3 form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                            ...
                            <input type="file" name="image" id="image" class="form-control form-control-alternative{{ $errors->has('image') ? ' is-invalid' : '' }}" value="{{ old('image', '') }}">
                        ...
                        <div class="col-md-3 imageDiv">
                            <img alt="Image placeholder" width="200" height="200" src="{{ url(config('constant.file_path.product')."/".$data->image) }}">
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('product_name_nl') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="product_name_nl" id="input-product_name_nl" class="form-control form-control-alternative{{ $errors->has('product_name_nl') ? ' is-invalid' : '' }}" placeholder="{{ __('Productnaam') }}" value="{{ old('product_name_nl', $translation['product_name']['nl'] ?? '') }}" autofocus>
                        ...
                        <div class="col-md-6 form-group{{ $errors->has('description_nl') ? ' has-danger' : '' }}">
                            ...
                            <textarea name="description_nl" id="description_nl" class="form-control form-control-alternative{{ $errors->has('description_nl') ? ' is-invalid' : '' }}" placeholder="{{ __('Omschrijving') }}" rows="5">{{ old('description_nl', $translation['description']['nl'] ?? '') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="switch">
                                <input name="status" type="checkbox" {{ $data->status == 1 ? 'checked' : '' }} >
